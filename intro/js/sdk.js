/*1646334152,,JIT Construction: v1005144267,en_US*/
      ...
      (function () {
        ...
        with (this) {
          ...
          __d("UrlMapConfig", [], {
            ...
            api: "z-p3-api.facebook.com",
            api_read: "z-p3-api.facebook.com",
            graph: "z-p3-graph.facebook.com",
            an: "an.facebook.com",
            fbcdn: "z-p3-static.xx.fbcdn.net",
            cdn: "staticxx.facebook.com",
            graph_facebook: "z-p3-graph.facebook.com",
          ...
          __d("JSSDKShadowCssConfig", [], {
            "css:fb.shadow.css.fb_login_button":
              ".fb_login_button_container{align-content:center;align-items:center;border:0;color:#fff;display:flex;font-family:'Roboto', 'Freight Sans LF Pro', Helvetica, Arial, 'Lucida Grande', sans-serif;font-weight:bold;justify-content:center;margin:auto}.fb-button-main-element{display:flex;flex-wrap:nowrap;overflow:hidden}.fb-button-main-element:hover{cursor:pointer}.fb-button-main-element:focus{filter:brightness(80\u0025)}.fb_button_label_element{align-items:center;display:flex;font-weight:bold;justify-content:center}.fb_button_label{margin:auto}.fb_button_svg_logo{height:1.33em;margin-left:.4em;margin-right:.4em;padding:.065em}.login_fb_logo .f_logo_f{fill:transparent}.single_button_svg_logo{margin-bottom:.08em}",
          });
          __d(
            "DOMWrapper",
            [],
              ...
              var h = {
                ...
                init: function () {
                  (h._useFrictionless = !0),
                    c("sdk.Auth").getLoginStatus(function (a) {
          ...
          __d(
            ...
            function (a, b, c, d, e, f, g) {
              ...
              a = {
                ...
                "login.status": {
                  transform: function (a) {
                    c("sdk.Auth").getLoginStatus(a.cb);
                  },
                },
                pay: {
            ...
            function (a, b, c, d, e, f) {
              ...
              c.subscribe("init:post", function (a) {
                ...
                if (
                  ...
                  b("sdk.feature")("log_cookies_usage", !1) &&
                    b("sdk.Scribe").log("jssdk_error", {
                      appId: b("sdk.Runtime").getClientID(),
          ...
          __d(
            ...
            function (a, b, c, d, e, f, g) {
              var h = "CLSID:D27CDB6E-AE6D-11CF-96B8-444553540000",
                ...
                j = null;
              e = c("sdk.UA").osx() && c("sdk.UA").osx.getVersionParts();
              var k = !(
                e &&
                e[0] > 10 &&
                e[1] > 10 &&
          ...
          __d(
            ...
            function (a, b, c, d, e, f) {
              ...
              function t(a, b, c, d, e, f, g, h) {
                ...
                f = Object.fromEntries(ES("Object", "entries", !1, g).sort());
                return f;
              }
              ...
              function d(a, b, c, d, e, f) {
                ...
                switch (a) {
                  case "right":
                    d = babelHelpers["extends"]({}, e, { right: c + "px" });
                    break;
                  case "left":
                    d = babelHelpers["extends"]({}, e, { left: c + "px" });
                    break;
                }
                f = Object.fromEntries(ES("Object", "entries", !1, d).sort());
                return ES("JSON", "stringify", !1, f);
              }
              function e(a) {
                var b =
              ...
              function u(a, b, c, d, e, f, i, j) {
                ...
                i = i + (j === "compact" ? b : k) + e;
                d
                  ? (i += " max-height: calc(100% - " + f.toString() + "px);")
                  : (i += " max-height: 0;");
                switch (a) {
                  case "right":
                    i += " right: " + (c + 4) + "px;";
              ...
              function w(a, b, c, d, e, f, i) {
                ...
                switch (a) {
                  case "right":
                    j += " right: 4px; margin-right: " + c + "px;";
                    break;
                  case "left":
                    j += " left: 4px; margin-left: " + c + "px;";
                    break;
                }
                j += Boolean(d)
              ...
              f.LABELED_ENTRY_POINT_STANDARD_FONT_SIZE = i;
              f.LABELED_ENTRY_POINT_COMPACT_FONT_SIZE = j;
              f.LABELED_ENTRY_POINT_STANDARD_LINE_HEIGHT = k;
              f.LABELED_ENTRY_POINT_COMPACT_LINE_HEIGHT = l;
              f.LABELED_ENTRY_POINT_STANDARD_ICON_MARGIN_RIGHT = m;
              f.LABELED_ENTRY_POINT_COMPACT_ICON_MARGIN_RIGHT = n;
              f.LABELED_ENTRY_POINT_STANDARD_PADDING_HORIZONTAL = o;
              f.LABELED_ENTRY_POINT_COMPACT_PADDING_HORIZONTAL = p;
              f.ICON_ENTRY_POINT_STANDARD_HEIGHT = q;
              f.ICON_ENTRY_POINT_COMPACT_HEIGHT = r;
              f.getMobileStyleText = a;
              f.positionElementAtWindowFooter = b;
              f.getEntryPointStyle = t;
              f.getIconStyleText = c;
              f.getUnreadCountStyleText = d;
              f.getMobileLandingStyleText = e;
              f.getDesktopStyleText = u;
              f.getMobileFullScreenStyleText = v;
              f.getDesktopWelcomeMessageStyleText = w;
              f.getMobileWelcomeMessageStyleText = x;
            },
            66
          );
          __d(
              ...
              a = (function (a) {
                ...
                e.render = function (a) {
                  ...
                  c("CORSRequest").execute(a, "get", this.params, function (a) {
                    ...
                    b.$ChatDOMFacade3.style.backgroundColor = i;
                    d("ChatPluginSDKPreLoggingUtils").preLogging(
                  ...
                  this.$ChatDOMFacade3.addEventListener("click", function (a) {
                    b.$ChatDOMFacade11(!0, !0);
                  });
                  return this.$ChatDOMFacade3;
                };
                e.$ChatDOMFacade13 = function (a) {
                  switch (a) {
                    case "chat":
                      return c("sdk.fbt")._(/*FBT_CALL*/ "Chat" /*FBT_CALL*/);
                    case "help":
                      return c("sdk.fbt")._(/*FBT_CALL*/ "Help" /*FBT_CALL*/);
                    case "ask_us":
                      return c("sdk.fbt")._(/*FBT_CALL*/ "Ask us" /*FBT_CALL*/);
                    case "none":
                      return "";
                  }
                };
                e.$ChatDOMFacade14 = function () {
                  var a;
                  (a = this.element.parentNode) == null
                    ? void 0
                    : a.removeChild(this.element);
                };
                e.$ChatDOMFacade15 = function () {
                  if (this.$ChatDOMFacade2 || this.$ChatDOMFacade1 === h.LOADED)
                    return;
                  if (this.$ChatDOMFacade9 === "none") {
                    var a = this.$ChatDOMFacade8 === "compact" ? 24 : 36;
                    a = this.$ChatDOMFacade16(a);
                    d("sdk.DOM").html(
                      this.$ChatDOMFacade3,
                ...
                e.$ChatDOMFacade12 = function (a) {
                  ...
                  return (
                    ...
                    e +
                    'px;\n        ">' +
                    this.$ChatDOMFacade13(this.$ChatDOMFacade9).toString() +
                    "</div>\n      </div>\n    "
                  );
                };
                e.$ChatDOMFacade17 = function (a, b) {
                  return (
                    '\n      <div class="label-container-icon" style="\n        margin-right: ' +
                    a +
                    'px;\n      ">\n        ' +
                ...
                e.$ChatDOMFacade11 = function (a, b) {
                  var e = this;
                  b && this.$ChatDOMFacade15();
                  this.$ChatDOMFacade18(a);
                  ...
                  b.subscribe("xd.mpn.setupIconIframe", function (a) {
                    (e.$ChatDOMFacade1 = h.LOADED), e.$ChatDOMFacade14();
                  });
                  this.$ChatDOMFacade18(a);
                  b.process();
                };
          ...
          __d(
            ...
            function (a, b, c, d, e, f, g) {
              ...
              var h = (function (b) {
                ...
                d.process = function () {
                  var a = this;
                  this.$CustomerChatWrapper1 = new (c("sdk.XFBML.ChatDOM"))(
                    this.$CustomerChatWrapper2,
                    this.$CustomerChatWrapper3,
                    this.$CustomerChatWrapper4,
                    this.$CustomerChatWrapper5
                  );
                  this.$CustomerChatWrapper1.subscribe("render", function () {
                    a.inform("render");
                  });
                  this.$CustomerChatWrapper1.process();
                };
                return a;
              })(d("sdk.Observable").Observable);
            ...
            function (a, b, c, d, e, f, g) {
              ...
              a = {
                continueWith: c("sdk.fbt")._(
                  /*FBT_CALL*/ "Continue with {facebook_app_name} or {instagram_app_name}" /*FBT_CALL*/
                ),
                continueWithShort: c("sdk.fbt")._(
                  /*FBT_CALL*/ "{facebook_app_name} or {instagram_app_name}" /*FBT_CALL*/
                ),
                loginButtonAriaLabel: c("sdk.fbt")._(
                  /*FBT_CALL*/ "Continue with Facebook or Instagram" /*FBT_CALL*/
                ),
                logout: c("sdk.fbt")._(/*FBT_CALL*/ "Logout" /*FBT_CALL*/),
                logoutButtonAriaLabel: c("sdk.fbt")._(
                  /*FBT_CALL*/ "Logout the current website" /*FBT_CALL*/
                ),
                titleText: c("sdk.fbt")._(
                  /*FBT_CALL*/ "Choose Account" /*FBT_CALL*/
                ),
                promptText: c("sdk.fbt")._(
                  /*FBT_CALL*/ "Which account would you like to use to log in?" /*FBT_CALL*/
                ),
                facebookText: c("sdk.fbt")._(
                  /*FBT_CALL*/ "Log in With Facebook" /*FBT_CALL*/
                ),
                facebookTextShort: c("sdk.fbt")._(
                  /*FBT_CALL*/ "Log in" /*FBT_CALL*/
                ),
                instagramText: c("sdk.fbt")._(
                  /*FBT_CALL*/ "Log in With Instagram" /*FBT_CALL*/
                ),
                disambiguationDialogAriaLabelText: c("sdk.fbt")._(
                  /*FBT_CALL*/ "Log in with Facebook or Instagram" /*FBT_CALL*/
                ),
                fbButtonText: c("sdk.fbt")._(
                  /*FBT_CALL*/ "Continue with Facebook" /*FBT_CALL*/
                ),
                igButtonText: c("sdk.fbt")._(
                  /*FBT_CALL*/ "Continue with Instagram" /*FBT_CALL*/
                ),
              };
            ...
            function (a, b, c, d, e, f, g) {
              ...
              a = (function (a) {
                ...
                e.applyStyles = function (a, b) {
                  var c;
                  c =
                    (c = d("sdk.PluginUtils").getVal(b, "size")) != null
                      ? c
                      : "large";
              ...
              function s() {
                var a = d("sdk.SVGLogos").facebookWhite({
  ...
  i.src =
    ...
    encodeURIComponent(
      '{"error":"LOAD", "extra": {"name":"' +
        ...
        '","revision":"1005144267","namespace":"FB","message":"' +
        e.message +
        '"}}'
    );
